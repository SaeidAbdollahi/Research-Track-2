...
def planning(goal):
    ...
    feedback = robot_sim.msg.PlanningFeedback()
    result = robot_sim.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', robot_sim.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
